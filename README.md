...
| **Shortest brick** | ≥ ⅓ of a stretcher | A course whose width is not a neat multiple of the brick length ends in a stub, and a 3.8 mm stub beside 18 mm neighbours reads as **a gap**, not as a short brick. Drop the joint and let the end brick run long — cut a closer, never lay a sliver |
| **Widest pane that bridges** | **12 mm** | The top of a window pane is a bridge. Scaling a window up therefore adds *mullions*; it does not stretch panes. A 36 mm window on two columns has 17.4 mm panes and nothing that wide has been printed |
