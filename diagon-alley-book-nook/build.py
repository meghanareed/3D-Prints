...
PRINT_ROT_MEASURED = {
    ...
    "07": ("Y", -90),      "08": ("X", 90),       "10B": ("X", 90),
    "10Bc": ("X", -90),    "10D": ("X", -90),     "10Gl": ("X", 90),
    "11Ac": ("X", -90),    "11Fl": ("X", 90),     "12Al": ("X", -90),
    "13As": ("X", 90),     "13Bs": ("X", 90),     "13Cs": ("X", 90),
    "13Ds": ("X", 90),     "13Es": ("X", 90),     "13Fs": ("X", 90),
    "13Gs": ("X", 90),     "14As": ("X", 90),     "14Bs": ("X", 90),
    "15A": ("X", 180),     "15B": ("X", 180),     "15C": ("X", -90),
    "17A": ("X", -90),     "17B": ("X", -90),     "18A": ("X", 90),
    "19B": ("X", 90),      "19C": ("X", 90),      "20Es": ("X", 90),
    "20G": ("X", 90),      "21Bl": ("X", -90),    "21D": ("X", -90),
    "21E": ("X", 180),     "22Al": ("X", -90),    "23As": ("X", 90),
    "23Bs": ("X", 90),     "23Cs": ("X", 90),     "23Ds": ("X", 90),
    "23Es": ("X", 90),     "23Fs": ("X", 90),     "23Gs": ("X", 90),
    "23Hs": ("X", 90),     "24Ac": ("X", -90),    "25A": ("X", 180),
    "25B": ("X", 180),     "27A": ("X", -90),     "27B": ("X", -90),
    "28A": ("X", 90),      "29B": ("X", 90),      "29C": ("X", 90),
