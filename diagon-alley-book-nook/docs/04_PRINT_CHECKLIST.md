...
**2 of 157 parts printed**, 1680 g of PLA in the whole kit across 20 plates.
...
## `09_facade_left.stl`  ---  31 parts, 38 g  (0/31 done)
...
## `10_facade_right.stl`  ---  28 parts, 27 g  (0/28 done)
...
## `13_bench_tools.stl`  ---  3 parts, 52 g  (0/3 done)

- [ ] `71A` Glazing_Cut_Template_A (28.1 g) -- **print with a brim**
