...
# -------------------------------------------------------------- tolerances --
# Set from the printed tolerance coupon on a Bambu P2S in PLA: the 0.25 station was
# the loosest that still held when the coupon was turned over. The coupon applies one
